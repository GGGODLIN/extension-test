(() => {
  ...
  // extensions/grassphere-checkout-ui/src/Checkout.jsx
...
${errorInfo.componentStack}`);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/checkout-token.mjs
  ...
  function App() {
    ...
    const [cvsState, setCvsState] = (0, import_react20.useState)(null);
    ...
    let ExtraData = { redirectUrl: `https://${testData2 == null ? void 0 : testData2.myshopifyDomain}/checkout`, checkoutToken: testData };
    let link = `https://philipextensiontest.myshopify.com/pages/test-page?ExtraData=${JSON.stringify(ExtraData)}`;
    (0, import_react20.useEffect)(() => {
      fetch(`https://philip.akohub.dev/ako/shopify/checkout/cvs/${testData}`).then((res) => res.json()).then((json) => {
        var _a;
        console.log("cvs", json);
        setCvsState((_a = json == null ? void 0 : json.cvsResult) == null ? void 0 : _a.cvsResult);
      });
    }, []);
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { spacing: "none", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Pressable2,
            {
              ...
              padding: "base",
              children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Choice2, { id: "second", children: "\u5B85\u914D" })
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Pressable2,
            {
              ...
              padding: ["tight", "base"],
              children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InlineLayout2, { blockAlignment: "center", columns: ["auto", "fill"], children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Choice2, { id: "first", children: "\u8D85\u5546\u53D6\u8CA8" }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InlineStack2, { inlineAlignment: "end", blockAlignment: "center", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Link2, { to: link, external: false, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Image2, { source: "https://cdn.shopify.com/s/files/1/0846/1788/8039/files/711-icon_34x33_81d376eb-9530-4fd7-8f7f-fd60af918487.png?v=1703144399" }) }),
                  cvsState && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { children: [
                    cvsState == null ? void 0 : cvsState.cvsStoreName,
                    ",",
                    cvsState == null ? void 0 : cvsState.cvsAddress
                  ] })
                ] })
              ] })
            }
